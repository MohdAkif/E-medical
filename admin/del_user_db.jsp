...
<%
   ...
   try{
        ...
        PreparedStatement ps5=con.prepareStatement("delete from  appointment where email_id=?;");
        PreparedStatement ps6=con.prepareStatement("delete from registration where email_id=?;");
